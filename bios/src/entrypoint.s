...
swi_table:
    ...
    .word swi_SoundDriverMode
    .word swi_SoundDriverMain
    .word swi_SoundDriverVSync
    .word swi_SoundChannelClear
    .word swi_MidiKey2Freq
    .word swi_SoundUndocumented @ SoundWhatever0 (GBATEK: undocumented)
    .word swi_SoundUndocumented @ SoundWhatever1
    .word swi_SoundUndocumented @ SoundWhatever2
    .word swi_SoundUndocumented @ SoundWhatever3
    .word swi_SoundUndocumented @ SoundWhatever4
    .word swi_MultiBoot
    .word swi_HardReset
    .word swi_CustomHalt
...
@ Literal pool for everything above. The included sources below grew
@ past the point where the end-of-file pool stayed within ldr range
@ of the reset/dispatch code.
.pool
